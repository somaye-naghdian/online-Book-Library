...
<h1 style="text-align: center; color: darkblue"> BOOK  DETAILS </h1>
    ...
    <input style="margin:5px;color: midnightblue;cursor: pointer;" type="submit" name="choice" value="ADD"></input>
    <input style="margin:5px;color: midnightblue;cursor: pointer;" type="submit" name="choice" value="DELETE"></input>
    <input style="margin:5px;color: midnightblue;cursor: pointer;" type="submit" name="choice" value="UPDATE"></input>
    <input style="margin:5px;color: midnightblue;cursor: pointer;" type="submit" name="choice" value="DISPLAY"></input>
    <input style="margin:5px;color: midnightblue;cursor: pointer;" type="submit" name="choice" value="SEARCH"></input>
